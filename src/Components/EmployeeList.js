...
//     const employeeAPI = (url = 'http://localhost:61848/api/Employee') => {
//         return {
...
//         employeeAPI().fetchAll().then(res => setEmployeeList(res.data))
    ...
    return (
        <div className="row">
            <div className="col-md-12">
                <div className="jumbotron jumbotron-fluid py-4">
                    <div className="container text-center">
                        <h1 className="display-6">Employee Registration Dashboard</h1>
                    </div>
                </div>
            </div>
            <div className="col-md-4">
